...
// Сделать приложение такси за месяц
  ...
  fun day12() {
    ...
    "Почему при фокусе на поле старта не срабатывает поисковый запрос( там пустая строка, почему она пустая?"

    // "Исправление багов"
    // "Добавление колбека выхода для экранов/диалогов"
    // "Обновление поисковой выдачи при переключении между полями"
  }
